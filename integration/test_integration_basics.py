...
class TestHttps(HttpsIntegrationTestBase):
  ...
  def test_h1_tls_context_configuration(self):
    ...
    self.assertNighthawkCounterEqual(parsed_json, "ssl.ciphers.ECDHE-RSA-AES128-SHA", 1)
    ...
    self.assertNighthawkCounterEqual(parsed_json, "ssl.ciphers.ECDHE-RSA-AES256-GCM-SHA384", 1)
